...
class Seq2SeqModel(object):
  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights,
    ...
    # print ("The loss in this step is:",outputs[2])
  ...
  def get_batch(self, data, bucket_id, pos):
    ...
    for _ in xrange(self.batch_size):
      ...
      encoder_input, decoder_input = data[bucket_id][pos%length]
      # print(encoder_input)
      # print("========================DIVIDING LINE===========================")
      # print(decoder_input)
      pos+=1
      ...
      # Create the list for decoding
      decoder_input = np.insert(decoder_input,0,data_utils.GO_ID)
    ...
    for length_idx in xrange(decoder_size):
      # print(decoder_inputs[0][length_idx],decoder_size)
      ...
      for batch_idx in xrange(self.batch_size):
        ...
        # NOTE: CHANGED FROM SUBTRACTING 1 TO SUBTRACTING 2
        if length_idx < decoder_size - 1:
          target = decoder_inputs[batch_idx][length_idx + 1]
        if length_idx == decoder_size - 1 or target == data_utils.PAD_ID:
          # print("########################INSIDE THE LOOP#############################")
          # print("Length: ", length_idx)
          # print("Decoder Size: ", decoder_size)
          # print("PAD ID: ", data_utils.PAD_ID)
          # print("Target: ", target)
